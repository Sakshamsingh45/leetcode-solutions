<h1>2202 - Sum of k-Mirror Numbers</h1><h2>Difficulty: Hard - <a href="https://leetcode.com/problems/sum-of-k-mirror-numbers/">sum-of-k-mirror-numbers</a></h2><p>A <strong>k-mirror number</strong> is a <strong>positive</strong> integer <strong>without leading zeros</strong> that reads the same both forward and backward in base-10 <strong>as well as</strong> in base-k.</p>
